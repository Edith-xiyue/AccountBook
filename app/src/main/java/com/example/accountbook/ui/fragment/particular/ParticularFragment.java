    ...
    public void onViewClicked() {
        ...
        if (!TextUtils.isEmpty(searchYear.getText().toString())){
            if (!TextUtils.isEmpty(searchMonth.getText().toString())){
                if (Integer.parseInt(searchMonth.getText().toString()) < 10 && !searchMonth.getText().toString().contains("0"))
                    filterDate = searchYear.getText().toString() + "-0" + searchMonth.getText().toString();
                else
                    filterDate = searchYear.getText().toString() + "-" + searchMonth.getText().toString();
                if (!TextUtils.isEmpty(searchDay.getText().toString())){
                    if (Integer.parseInt(searchDay.getText().toString()) < 10 && !searchDay.getText().toString().contains("0"))
                        filterDate = filterDate + "-0" + searchDay.getText().toString();
                    else
                        filterDate = filterDate + "-" + searchDay.getText().toString();
